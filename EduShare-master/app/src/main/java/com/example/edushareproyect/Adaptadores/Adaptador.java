...
public class Adaptador extends ArrayAdapter<FotografiaUsuario> {

    ArrayList<FotografiaUsuario> listado = new ArrayList<>();

    public Adaptador(Context context, int textViewResourceId, ArrayList<FotografiaUsuario> objects) {
