 ...
 * Use the {@link VerContacto#newInstance} factory method to
 * create an instance of this fragment.
 */
public class VerContacto extends Fragment {
    ...
    public VerContacto(String idContacto) {
     ...
     * @return A new instance of fragment VerContacto.
     */
    // TODO: Rename and change types and number of parameters
    public static VerContacto newInstance(String param1, String param2) {
        VerContacto fragment = new VerContacto();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_ver_contacto, container, false);

        informacionSession = root.getContext().getSharedPreferences("session", Context.MODE_PRIVATE);

        txtNombres = (TextView) root.findViewById(R.id.lblNombreAmigo);
        txtTelefono = (TextView) root.findViewById(R.id.lblTelefonoAmigo);
        txtCarrera = (TextView) root.findViewById(R.id.lblCarreraAmigo);
    ...
    private void eliminarAmigo() {
        new AlertDialog.Builder(getContext())
                ...
                .setMessage("¿Desea eliminar a " + txtNombres.getText() + " de su lista de amigos?")
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {

                        RequestQueue queue = Volley.newRequestQueue(getContext());
                        String url = RestApiMehotds.ApiPostDeleteFriend;
    ...
    private void PostAmigo(){
        RequestQueue queue = Volley.newRequestQueue(getContext());
        String url = RestApiMehotds.ApiPostInfoFriend;
        String token = informacionSession.getString("token","");
        JSONObject postData = new JSONObject();
        try {
            postData.put("token",token);
                ...
                try {
                    if(response.getString("status").equalsIgnoreCase("1")) {
                        ...
                        for (int i = 0; i < amigoArrayJSON.length(); i++) {
                            ...
                            amigo = new Amigo(grupoObject.getString("CONTACTO"),
                        ...
                        txtNombres.setText(amigo.getNombres());
                        txtTelefono.setText(amigo.getTelefono());
                        txtCarrera.setText(amigo.getCarrera());
                        txtCampus.setText(amigo.getCampus());
                        txtCorreo.setText(amigo.getCorreo());
                        ...
                        if(amigo.getFoto().equalsIgnoreCase("null") == false) {
                            ...
                            imgAmigo.setImageBitmap(bitMapFoto);
                        }else {
                            imgAmigo.setImageResource(R.drawable.img_default);
                        }
                    }else{
